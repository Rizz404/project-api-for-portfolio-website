...
func (h *CategoryHandler) CreateCategory(w http.ResponseWriter, r *http.Request) {
	...
	if err := json.NewDecoder(r.Body).Decode(&payload); err != nil {
		Error(w, http.StatusBadRequest, "Invalid request payload: "+err.Error(), nil)
		return
	}

	category, err := h.Service.CreateCategory(r.Context(), &payload)
	if err != nil {
		Error(w, http.StatusConflict, "Failed to create category, perhaps it already exists.", nil)
		return
	}

	Success(w, http.StatusCreated, "Category created successfully", category)
}

func (h *CategoryHandler) GetCategories(w http.ResponseWriter, r *http.Request) {
	categories, err := h.Service.GetCategories(r.Context())
	if err != nil {
		Error(w, http.StatusInternalServerError, "Could not fetch categories.", nil)
		return
	}
	Success(w, http.StatusOK, "Categories fetched successfully", categories)
}
...
func (h *CategoryHandler) GetCategory(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		Error(w, http.StatusNotFound, "Category with ID '"+id+"' not found.", nil)
		return
	}
	Success(w, http.StatusOK, "Category fetched successfully", category)
}
...
func (h *CategoryHandler) UpdateCategory(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		Error(w, http.StatusNotFound, "Failed to update: category with ID '"+id+"' not found.", nil)
		return
	}

	Success(w, http.StatusOK, "Category updated successfully", updatedCategory)
}
...
func (h *CategoryHandler) DeleteCategory(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		Error(w, http.StatusNotFound, "Failed to delete: category with ID '"+id+"' not found.", nil)
		return
	}
	Success(w, http.StatusOK, "Category deleted successfully", nil)
}
